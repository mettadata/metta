...
## Reference
- [Project Constitution](.metta/project.md) — full principles, constraints, quality standards
- [Active Specs](metta/specs/) — current requirements and scenarios
- [Active Changes](metta/changes/) — work in flight
...
Metta generates and maintains project documentation in a configurable output directory. After work is built and verified, the framework has all the information — specs, designs, architecture decisions, implementation summaries — and writes human-readable docs from it.

```yaml
# .metta/config.yaml (or ~/.metta/config.yaml for global default)
docs:
  output: ./docs              # Where to write generated docs
...
<!-- Source: metta/specs/auth/, metta/archive/2026-04-05-add-mfa/ -->
