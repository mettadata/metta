...
5. Output
   ...
   → docs/gaps/<gap-name>.md (one file per gap)
```

### Gaps — Individual Files Per Gap

After import, Metta writes one file per gap in `docs/gaps/`. Each gap is a self-contained document — easy to track, review, assign, and promote into a spec.
...
```markdown
<!-- docs/gaps/payments-partial-refunds.md -->
...
## Related Spec
docs/specs/payments/spec.md — Requirement: Refund Processing
...
```markdown
<!-- docs/gaps/auth-rate-limiting-undocumented.md -->
<!-- Generated by metta import — 2026-04-05 -->
...
```markdown
<!-- docs/gaps/auth-session-expiry-divergence.md -->
<!-- Generated by metta import — 2026-04-05 -->
