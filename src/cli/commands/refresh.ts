...
export function buildReferenceSection(): string {
  ...
  lines.push('| [Issues](spec/issues/) | `spec/issues/` | Logged issues and backlog items (backlog is a frontmatter view) |')
  lines.push('| [Milestones](spec/milestones/) | `spec/milestones/` | Milestone groupings for backlog items |')
