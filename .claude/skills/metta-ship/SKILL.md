...
10. **Post-merge release stage** — execute the `### Post-merge release stage` block below in full, then continue to step 11
...
11. Report result to user, including the dist rebuild outcome
