...
- [x] **Task 1.1: Rewrite workflow primer and update/extend its test suite**
...
- [x] **Task 1.2: Comment-only SYNC annotations in both guard hook copies**
...
- [x] **Task 1.3: Rewrite docs/workflows/README.md "Core rule: skills, not CLI"**
...
- [x] **Task 2.1: Pin read-only subsection in buildWorkflowSection output**
  - **Depends on**: Task 1.1
...
- [x] **Task 2.2: Hand-apply regenerated metta:workflow region to metta's own CLAUDE.md**
  - **Depends on**: Task 1.1
