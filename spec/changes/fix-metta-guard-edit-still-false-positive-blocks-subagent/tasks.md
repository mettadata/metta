...
- [ ] **Task 1.1: Apply ADR-4 spec wording edits (session root -> hosting root)**
...
- [ ] **Task 1.2: Implement `deriveProbeRoot()` in the guard-edit hook (template + deployed mirror, byte-identical)**
...
- [ ] **Task 2.1: Real-CLI topology regression suite + fail-open cases + ADR-5 shim update**
...
- [ ] **Task 3.1: Full gates run and closeout check**
