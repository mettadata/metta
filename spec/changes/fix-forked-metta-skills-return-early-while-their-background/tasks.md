...
- [ ] **Task 1.1: `checkFinalizeLockStale`, mtime fallback, and reworded `FinalizeLockError`**
...
- [ ] **Task 1.2: Unit tests for `checkFinalizeLockStale` and the reworded error message**
