...
## US-2: Catch broken story↔requirement traceability before ship
...
**Priority:** P2
**Independent Test Criteria:** A change with stories.md containing only the sentinel `## No user stories — internal/infrastructure change` + `**Justification:** ...` passes finalize without any `Fulfills` references in spec.md.
