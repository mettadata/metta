...
- [x] **Task 2.1: Flip downscale default and record escalation in complete.ts**
...
- [x] **Task 2.2: Downscale-default matrix and escalation tests**
...
- [x] **Task 3.1: Surface escalation in metta status (human + --json)**
...
- [x] **Task 3.3: Wire ceremony metrics into metta progress**
