...
- [ ] **Task 1.1: RoadmapStore module (functional core + imperative shell)**
...
- [ ] **Task 1.2: buildPromoteHandoff helper + backlog promote recomposition**
...
- [ ] **Task 1.3: Guard hook — Tier-2 roadmap mutations + ALLOWED_BARE view**
...
- [ ] **Task 1.4: Mint hook — metta-roadmap scope**
...
- [ ] **Task 1.5: /metta-roadmap skill (templated pair)**
...
- [ ] **Task 2.1: CLI command group + context/barrel wiring**
...
- [ ] **Task 2.2: RoadmapStore unit tests**
  - **Depends on**: Task 1.1
...
- [ ] **Task 2.3: Guard integration test additions**
...
- [ ] **Task 3.1: Roadmap CLI integration tests**
  - **Depends on**: Task 2.1
...
- [ ] **Task 4.1: Full gates — suite, types, lint, build, template deployment**
