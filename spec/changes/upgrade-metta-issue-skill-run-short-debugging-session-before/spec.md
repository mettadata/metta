...
## ADDED: Requirement: Metta-issue skill performs root cause analysis before writing the ticket
...
## ADDED: Requirement: Metta-issue skill supports --quick escape hatch
...
## ADDED: Requirement: Metta-issue skill falls back to shallow log when RCA fails
...
## ADDED: Requirement: Metta-issue skill writes a structured body with fixed section order
...
## ADDED: Requirement: Metta issue CLI auto-detects piped stdin as body
