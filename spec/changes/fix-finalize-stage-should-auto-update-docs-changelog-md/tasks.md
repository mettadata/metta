...
- [ ] **Task 1.1: Default the `docs` block in `ProjectConfigSchema`**
...
- [ ] **Task 1.2: Simplify the finalizer doc-generation guard**
...
- [ ] **Task 2.1: Add `ProjectConfigSchema` default-resolution tests**
  - **Depends on**: Task 1.1
...
- [ ] **Task 2.2: Add finalizer doc-generation integration tests**
  - **Depends on**: Task 1.2
