...
## ADDED: Requirement: Default `docs` block in `ProjectConfigSchema`
...
## ADDED: Requirement: Original docs-generate spec compliance
...
## ADDED: Requirement: No changes to `DocGenerator`, `DocsConfigSchema` inner defaults, or finalizer flow ordering
