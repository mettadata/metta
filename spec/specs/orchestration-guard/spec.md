...
## Requirement: Workflow Primer Mandate Is Scoped to Mutating Commands
...
## Requirement: Workflow Primer Documents the Permitted Read-Only Surface
...
## Requirement: All Workflow-Rule Copies Agree Across Primer, CLAUDE.md, and Docs
...
## Requirement: Cross-Referenced Sync Reminders Between Primer and Guard Allow-Lists
