...
```json
{
  ...
  "agent_type": "<PreToolUse event agent_type field value, or null if not present>",
  "skill_bypass": "<boolean: whether the tokenizer detected an inline METTA_SKILL=1 prefix on the command string>",
