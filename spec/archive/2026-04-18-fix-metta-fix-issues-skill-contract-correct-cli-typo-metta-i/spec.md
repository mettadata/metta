...
## ADDED: Requirement: fix-issues-skill-uses-plural-issues-show
...
## ADDED: Requirement: skills-describe-orchestrator-owned-commits
...
## ADDED: Requirement: metta-product-agent-has-bash-tool
...
## ADDED: Requirement: deployed-skill-mirrors-stay-byte-identical
