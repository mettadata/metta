...
- [x] **Files:** `src/templates/statusline/statusline.mjs`
...
### Task 1.3: Add installMettaStatusline helper to install.ts [x]
...
- [x] **Files:** `test/cli/commands/install-statusline.test.ts`
