...
## ADDED: Requirement: BashHookBlocksMutatingCommands
...
- `metta propose`, `metta quick`, `metta auto`, `metta complete`, `metta finalize`, `metta ship`
- `metta issue`, `metta fix-issue`, `metta fix-gap`, `metta refresh`, `metta import`
- `metta install`, `metta init`
- `metta backlog add`, `metta backlog done`, `metta backlog promote`
...
## ADDED: Requirement: BashHookPassesReadOnlyCommands
...
## ADDED: Requirement: BashHookBypassesWithMettaSkillEnv
...
## ADDED: Requirement: BashHookSkipsNonBashEvents
...
## ADDED: Requirement: BashHookEmergencyBypass
...
## ADDED: Requirement: HumanTerminalUsageUnaffected
...
## ADDED: Requirement: InstallRegistersHook
...
## ADDED: Requirement: ReviewFanOutPathsInTree
...
- `spec/changes/<name>/review/correctness.md`
- `spec/changes/<name>/review/security.md`
- `spec/changes/<name>/review/quality.md`
...
## ADDED: Requirement: VerifyFanOutPathsInTree
...
- `spec/changes/<name>/verify/tests.md`
- `spec/changes/<name>/verify/tsc-lint.md`
- `spec/changes/<name>/verify/scenarios.md`
...
## ADDED: Requirement: ByteIdenticalSkillMirrors
