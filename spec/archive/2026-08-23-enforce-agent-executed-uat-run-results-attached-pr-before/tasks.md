...
- [x] **Task 1.1: Add uat.enforce_on_ship to the config schema**
...
- [x] **Task 1.2: Scaffold explicit uat block in metta install**
...
- [x] **Task 2.2: metta-ship skill pair — gate block, Agent tool, already-finalized branch**
...
- [x] **Task 2.3: metta-propose skill pair — gate block and failed-gate hand-back**
  - **Depends on**: Batch 1 complete (gate text frozen above; no file dependency)
...
- [x] **Task 2.4: metta-quick skill pair — gate block**
  - **Depends on**: Batch 1 complete (gate text frozen above; no file dependency)
...
- [x] **Task 2.5: metta-auto skill pair — gate block**
  - **Depends on**: Batch 1 complete (gate text frozen above; no file dependency)
...
- [x] **Task 2.6: metta-fix-issues skill pair — gate block plus step-11 blocking**
  - **Depends on**: Batch 1 complete (gate text frozen above; no file dependency)
...
- [x] **Task 2.7: metta-fix-gap skill pair — gate block plus step-11 blocking**
  - **Depends on**: Batch 1 complete (gate text frozen above; no file dependency)
...
- [x] **Task 3.1: Emit uatEnforceOnShip from the finalize CLI**
...
- [x] **Task 3.2: New grep-assert suite tests/skill-uat-ship-gate.test.ts**
...
- [x] **Task 3.3: Changelog entry for the ship-path UAT gate**
...
- [x] **Task 4.1: Repo-wide verification gates**
