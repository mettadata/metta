...
This capability defines the instruction-mode contract for checking a change's `spec.md` against the project constitution (`spec/project.md`), replacing the direct-API execution model. It covers the two-step CLI flow (emit contract, record verdict), the skill that drives a Read-only subagent between the two steps, and the preserved severity/exit-code/output contract.

## ADDED: Requirement: Contract Emission Without API Credentials
...
## ADDED: Requirement: No Direct AI Provider Invocation
...
## ADDED: Requirement: Verdict Schema Validation
...
## ADDED: Requirement: Verdict Recording and Blocking-Violation Exit Semantics
...
## ADDED: Requirement: Violations Report Format and Location Preserved
...
## ADDED: Requirement: Skill-Driven Two-Step Check Flow
...
## ADDED: Requirement: Idempotent Re-Check Replaces the Prior Verdict
