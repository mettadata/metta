...
<!-- Scope note: US-3 (trivial/quick workflow dedupe) belongs to the adaptive-workflow-tier-selection
capability and US-4 (gate-scaffold liveness) belongs to the gate-runner capability, but a delta spec
can target only one capability H1 per file (known limitation, see issue
spec-delta-artifact-template-pre-fills-the-h1-with-the). Those two stories are covered by their
stories.md acceptance criteria plus tests; any capability-spec updates they require are made as
direct edits to adaptive-workflow-tier-selection/spec.md and gate-runner/spec.md during
implementation, not as ADDED requirements in this file. -->

## ADDED: Requirement: Persona Text Is Derived At Runtime From The Agent Definition
...
## ADDED: Requirement: Every Referenced Agent Name Resolves To An Existing Agent Definition
...
## ADDED: Requirement: Agent Resolution Failure Fails Loudly, Never Silently Substitutes
...
## ADDED: Requirement: Agent Aliases Are Explicit And Resolve To The Real Agent's Identity
...
## ADDED: Requirement: Emitted Instructions Contract Carries Complete Agent Identity
...
## ADDED: Requirement: Source And Deployed Agent Definitions Remain Byte-Identical
