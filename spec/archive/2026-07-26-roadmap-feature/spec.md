...
<!-- Merge target: the H1 above must name an existing capability. To create a NET-NEW capability instead, add an HTML comment line containing exactly new-capability immediately under the H1 to confirm it. -->

## ADDED: Requirement: Roadmap persists as a single ordered markdown file managed by RoadmapStore
...
## ADDED: Requirement: Default roadmap command is a read-only ordered status view
...
## ADDED: Requirement: Dangling entries are surfaced, never fatal
...
## ADDED: Requirement: roadmap add appends an existing backlog item to the end of the queue
...
## ADDED: Requirement: roadmap reorder accepts only a complete non-interactive permutation
...
## ADDED: Requirement: roadmap next activates the top entry through the backlog promote path and pops it
...
## ADDED: Requirement: Mutating roadmap operations enforce main-branch and auto-commit discipline
...
## ADDED: Requirement: Roadmap failures use the standard error contract
...
## ADDED: Requirement: Roadmap wiring is additive to the CLI context and barrel exports
...
## ADDED: Requirement: Guard hook tiers roadmap forms — mutations Tier 2, status view unguarded
...
## ADDED: Requirement: The /metta-roadmap skill wraps all mutating roadmap operations
...
## ADDED: Requirement: Orchestrators answer "what next?" from the roadmap top entry
