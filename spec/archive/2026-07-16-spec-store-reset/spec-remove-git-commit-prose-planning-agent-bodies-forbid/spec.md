...
## Requirement: planning-agent-bodies-have-no-git-commit-prose
...
## Requirement: executor-forbids-tasks-md-modification
...
## Requirement: deployed-agent-mirrors-stay-byte-identical
