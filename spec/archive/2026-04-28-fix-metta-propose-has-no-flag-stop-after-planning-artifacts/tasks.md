...
- [x] **Task 1.1: Add `stop_after` optional field to `ChangeMetadataSchema`**
...
- [x] **Task 1.2: Add schema test cases for `stop_after`**
...
- [x] **Task 2.1: Extend `ArtifactStore.createChange` to accept and persist `stopAfter`**
  - **Depends on**: Task 1.1
...
- [x] **Task 2.2: Add `ArtifactStore.createChange` test cases for `stopAfter`**
  - **Depends on**: Task 1.1
...
- [x] **Task 3.1: Add `--stop-after <artifact>` option to `metta propose` and validate against the workflow's `buildOrder`**
  - **Depends on**: Task 2.1
...
- [x] **Task 3.2: Add end-to-end CLI test for `--stop-after`**
  - **Depends on**: Task 2.1
...
- [x] **Task 4.1: Update `.claude/skills/metta-propose/SKILL.md` Step 1 argument parsing and Step 3 boundary check**
  - **Depends on**: Task 3.1
...
- [x] **Task 4.2: Add a regression test that `metta status --json` surfaces `stop_after`**
  - **Depends on**: Task 2.1
...
- [x] **Task 5.1: Build, full-test sweep, lint, typecheck**
